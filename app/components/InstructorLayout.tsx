  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-gray-900">
      ...
      <div className="hidden md:flex md:w-64 md:flex-col">
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-white dark:bg-gray-800 border-r border-slate-200 dark:border-gray-700">
          {/* Logo */}
          ...
          <div className="mt-5 flex-grow flex flex-col">
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`${
                      isActive
                        ? 'bg-slate-100 dark:bg-gray-700 text-slate-900 dark:text-white border-r-2 border-slate-600'
                  ...
                  >
                    <span className={`${isActive ? 'text-slate-600 dark:text-slate-300' : 'text-slate-400 dark:text-slate-400 group-hover:text-slate-500 dark:group-hover:text-slate-300'} mr-3`}>
                      {item.icon}
                    </span>
                    {item.name}
                  </Link>
            ...
            {/* Bottom section */}
            <div className="flex-shrink-0 flex border-t border-slate-200 dark:border-gray-700 p-4">
      ...
      <div className="md:hidden">
        <div className="flex items-center justify-between h-16 px-4 bg-white dark:bg-gray-800 border-b border-slate-200 dark:border-gray-700">
