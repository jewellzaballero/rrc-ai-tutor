...
export default function InstructorCourses() {
  ...
  const [deleteConfirmation, setDeleteConfirmation] = useState<{isOpen: boolean; courseId: number | null; courseName: string}>({
    isOpen: false,
    courseId: null,
    courseName: ""
  });
  ...
  const confirmDeleteCourse = () => {
    if (deleteConfirmation.courseId) {
      setCourses(courses.filter(course => course.id !== deleteConfirmation.courseId));
    }
    setDeleteConfirmation({ isOpen: false, courseId: null, courseName: "" });
  };
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-md">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Delete Course</h3>
              </div>
